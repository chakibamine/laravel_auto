...
} elseif ($_instance->childHasBeenRendered('ppgcZMV')) {
    $componentId = $_instance->getRenderedChildComponentId('ppgcZMV');
    $componentTag = $_instance->getRenderedChildComponentTagName('ppgcZMV');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ppgcZMV');
} else {
    $response = \Livewire\Livewire::mount('student');
    $html = $response->html();
    $_instance->logRenderedChild('ppgcZMV', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php endif; ?> <?php /**PATH D:\laravel\volt-laravel-dashboard - Copy - Copy\resources\views/students/index.blade.php ENDPATH**/ ?>