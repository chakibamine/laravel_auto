            ...
            <div class="card border-0 shadow">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between border-bottom py-3">
                        ...
                        <div>
                            <span class="badge bg-info"><?php echo e($exam->date_exam->format('d M')); ?></span>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <div class="card border-0 shadow">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between border-bottom py-3">
                        ...
                        <div>
                            <span class="badge bg-primary"><?php echo e($total); ?> Students</span>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col text-end">
                            <a href="<?php echo e(route('comptabilite')); ?>" class="btn btn-sm btn-primary">View Full Report</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <span class="h3 font-bold mb-0"><?php echo e(number_format($totalRevenue, 2)); ?> DH</span>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <span class="h3 font-bold mb-0"><?php echo e(number_format($totalExpenses, 2)); ?> DH</span>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <span class="h3 font-bold mb-0 <?php echo e($netIncome >= 0 ? 'text-success' : 'text-danger'); ?>">
                                                <?php echo e(number_format($netIncome, 2)); ?> DH
                                            </span>
                                        </div>
                                        <div class="col-auto">
                                            <div class="icon icon-shape <?php echo e($netIncome >= 0 ? 'bg-success' : 'bg-danger'); ?> text-white text-lg rounded-circle">
