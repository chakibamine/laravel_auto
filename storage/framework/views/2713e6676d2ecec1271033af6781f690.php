...
} elseif ($_instance->childHasBeenRendered('mub52ZC')) {
    $componentId = $_instance->getRenderedChildComponentId('mub52ZC');
    $componentTag = $_instance->getRenderedChildComponentTagName('mub52ZC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('mub52ZC');
} else {
    $response = \Livewire\Livewire::mount('student');
    $html = $response->html();
    $_instance->logRenderedChild('mub52ZC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php endif; ?> <?php /**PATH D:\laravel\volt-laravel-dashboard - Copy\resources\views/students/index.blade.php ENDPATH**/ ?>