...
} elseif ($_instance->childHasBeenRendered('ZthMQZw')) {
    $componentId = $_instance->getRenderedChildComponentId('ZthMQZw');
    $componentTag = $_instance->getRenderedChildComponentTagName('ZthMQZw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ZthMQZw');
} else {
    $response = \Livewire\Livewire::mount('comptabilite');
    $html = $response->html();
    $_instance->logRenderedChild('ZthMQZw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
