...
} elseif ($_instance->childHasBeenRendered('MgIURuH')) {
    $componentId = $_instance->getRenderedChildComponentId('MgIURuH');
    $componentTag = $_instance->getRenderedChildComponentTagName('MgIURuH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MgIURuH');
} else {
    $response = \Livewire\Livewire::mount('comptabilite');
    $html = $response->html();
    $_instance->logRenderedChild('MgIURuH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
