...
} elseif ($_instance->childHasBeenRendered('vDLMEKj')) {
    $componentId = $_instance->getRenderedChildComponentId('vDLMEKj');
    $componentTag = $_instance->getRenderedChildComponentTagName('vDLMEKj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vDLMEKj');
} else {
    $response = \Livewire\Livewire::mount('comptabilite');
    $html = $response->html();
    $_instance->logRenderedChild('vDLMEKj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
