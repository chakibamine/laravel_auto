...
} elseif ($_instance->childHasBeenRendered('N6brqTX')) {
    $componentId = $_instance->getRenderedChildComponentId('N6brqTX');
    $componentTag = $_instance->getRenderedChildComponentTagName('N6brqTX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('N6brqTX');
} else {
    $response = \Livewire\Livewire::mount('logout', []);
    $html = $response->html();
    $_instance->logRenderedChild('N6brqTX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></a>
          </div>
...
</nav><?php /**PATH D:\laravel\volt-laravel-dashboard - Copy - Copy\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>