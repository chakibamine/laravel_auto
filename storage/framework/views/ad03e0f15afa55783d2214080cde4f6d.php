...
} elseif ($_instance->childHasBeenRendered('GJgBy29')) {
    $componentId = $_instance->getRenderedChildComponentId('GJgBy29');
    $componentTag = $_instance->getRenderedChildComponentTagName('GJgBy29');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GJgBy29');
} else {
    $response = \Livewire\Livewire::mount('dossier-list');
    $html = $response->html();
    $_instance->logRenderedChild('GJgBy29', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
