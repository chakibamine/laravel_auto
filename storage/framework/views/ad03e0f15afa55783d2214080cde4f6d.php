...
} elseif ($_instance->childHasBeenRendered('w6nQVxX')) {
    $componentId = $_instance->getRenderedChildComponentId('w6nQVxX');
    $componentTag = $_instance->getRenderedChildComponentTagName('w6nQVxX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('w6nQVxX');
} else {
    $response = \Livewire\Livewire::mount('dossier-list');
    $html = $response->html();
    $_instance->logRenderedChild('w6nQVxX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
