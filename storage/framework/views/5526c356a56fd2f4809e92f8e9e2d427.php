                            ...
                            <form wire:submit.prevent="register" action="#" method="POST">
                                ...
                                <div class="form-group mt-4 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input wire:model="name" id="name" type="text" class="form-control" placeholder="John Doe" autofocus required>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="d-flex justify-content-center align-items-center mt-4">
                                <span class="fw-normal">
                                    ...
                                    <a href="<?php echo e(route('login')); ?>" class="fw-bold">Login here</a>
                                </span>
                            </div>
                        </div>
                    </div>
    ...
    </main><?php /**PATH D:\laravel\volt-laravel-dashboard - Copy - Copy\resources\views/livewire/auth/register.blade.php ENDPATH**/ ?>