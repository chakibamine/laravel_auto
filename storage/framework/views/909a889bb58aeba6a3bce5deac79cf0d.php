...
} elseif ($_instance->childHasBeenRendered('3fTtgtS')) {
    $componentId = $_instance->getRenderedChildComponentId('3fTtgtS');
    $componentTag = $_instance->getRenderedChildComponentTagName('3fTtgtS');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3fTtgtS');
} else {
    $response = \Livewire\Livewire::mount('dossier-list');
    $html = $response->html();
    $_instance->logRenderedChild('3fTtgtS', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php endif; ?> <?php /**PATH D:\laravel\volt-laravel-dashboard - Copy - Copy\resources\views/dossiers/index.blade.php ENDPATH**/ ?>