...
} elseif ($_instance->childHasBeenRendered('opiQfhR')) {
    $componentId = $_instance->getRenderedChildComponentId('opiQfhR');
    $componentTag = $_instance->getRenderedChildComponentTagName('opiQfhR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('opiQfhR');
} else {
    $response = \Livewire\Livewire::mount('student');
    $html = $response->html();
    $_instance->logRenderedChild('opiQfhR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
