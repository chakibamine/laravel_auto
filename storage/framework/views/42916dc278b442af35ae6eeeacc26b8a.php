                                ...
                                <span wire:key="paginator-page<?php echo e($page); ?>">
                                    <?php if($page == $paginator->currentPage()): ?>
                                        <span aria-current="page">
                                            <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white bg-blue-600 border border-blue-600 cursor-default leading-5 select-none"><?php echo e($page); ?></span>
                                        </span>
                                    <?php else: ?>
...
<?php endif; ?> <?php /**PATH D:\laravel\volt-laravel-dashboard\resources\views/vendor/livewire/simple-tailwind.blade.php ENDPATH**/ ?>