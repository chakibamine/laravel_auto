...
} elseif ($_instance->childHasBeenRendered('isOBcJc')) {
    $componentId = $_instance->getRenderedChildComponentId('isOBcJc');
    $componentTag = $_instance->getRenderedChildComponentTagName('isOBcJc');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('isOBcJc');
} else {
    $response = \Livewire\Livewire::mount('cloture');
    $html = $response->html();
    $_instance->logRenderedChild('isOBcJc', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
