...
} elseif ($_instance->childHasBeenRendered('OUtYpVs')) {
    $componentId = $_instance->getRenderedChildComponentId('OUtYpVs');
    $componentTag = $_instance->getRenderedChildComponentTagName('OUtYpVs');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OUtYpVs');
} else {
    $response = \Livewire\Livewire::mount('cloture');
    $html = $response->html();
    $_instance->logRenderedChild('OUtYpVs', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
