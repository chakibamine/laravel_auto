...
} elseif ($_instance->childHasBeenRendered('TDoixtT')) {
    $componentId = $_instance->getRenderedChildComponentId('TDoixtT');
    $componentTag = $_instance->getRenderedChildComponentTagName('TDoixtT');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TDoixtT');
} else {
    $response = \Livewire\Livewire::mount('cour-list', []);
    $html = $response->html();
    $_instance->logRenderedChild('TDoixtT', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('GUAAiWp')) {
    $componentId = $_instance->getRenderedChildComponentId('GUAAiWp');
    $componentTag = $_instance->getRenderedChildComponentTagName('GUAAiWp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GUAAiWp');
} else {
    $response = \Livewire\Livewire::mount('components.add-cour-modal', []);
    $html = $response->html();
    $_instance->logRenderedChild('GUAAiWp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
