...
} elseif ($_instance->childHasBeenRendered('DLUocT2')) {
    $componentId = $_instance->getRenderedChildComponentId('DLUocT2');
    $componentTag = $_instance->getRenderedChildComponentTagName('DLUocT2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DLUocT2');
} else {
    $response = \Livewire\Livewire::mount('logout', []);
    $html = $response->html();
    $_instance->logRenderedChild('DLUocT2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></a>
          </div>
...
</nav><?php /**PATH D:\laravel\volt-laravel-dashboard - Copy\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>