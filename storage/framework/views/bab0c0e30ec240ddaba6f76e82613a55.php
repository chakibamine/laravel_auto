                ...
                <div class="col-md-3">
                    <div class="input-group">
                        <input type="text" 
                               ...
                               value="<?php echo e(str_pad($currentMonth, 2, '0', STR_PAD_LEFT)); ?>/<?php echo e($currentYear); ?>">
...
<script>
    document.addEventListener('livewire:load', function () {
        $('.datepicker').datepicker({
            ...
            window.livewire.find('<?php echo e($_instance->id); ?>').set('selectedMonth', e.date.getMonth() + 1 + '/' + e.date.getFullYear());
        });
    });
</script>
<?php $__env->stopPush(); ?> <?php /**PATH D:\laravel\volt-laravel-dashboard\resources\views/livewire/comptabilite.blade.php ENDPATH**/ ?>