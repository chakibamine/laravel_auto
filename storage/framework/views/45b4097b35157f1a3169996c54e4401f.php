            ...
            <td valign="top">
                    ...
                    <tbody>
                        <tr>
                            <td valign="top" width="35%" style="font-size:12px;">
                                ...
                                <strong>Date de cloture : </strong><?php echo e($month); ?><br>
                            </td>
                            <td valign="top" width="35%"></td>
                            <td valign="top" width="30%" style="font-size:12px;">
                                Date de Fiche: <?php echo e(now()->format('d/m/y')); ?><br>
                            </td>
                        </tr>
                    </tbody>
                </table>
                <table width="100%" cellspacing="0" cellpadding="2" border="1" bordercolor="#CCCCCC">
                    <tbody>
                        ...
                        <?php if(isset($dossiers) && $dossiers->count() > 0): ?>
                            <?php $__currentLoopData = $dossiers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td valign='top' style='font-size:12px;'><?php echo e($row->n_serie); ?></td>
                                    <td valign='top' style='font-size:12px;'><?php echo e($row->student->cin); ?></td>
                                    <td valign='top' style='font-size:12px;'><?php echo e($row->student->lastname); ?> <?php echo e($row->student->firstname); ?></td>
                                    <td valign='top' style='font-size:12px;'><?php echo e($row['category']); ?></td>
                                    <td valign='top' style='font-size:12px;'><?php echo e(\Carbon\Carbon::parse($row["date_inscription"])->format('d/m/Y H:i')); ?></td>
                                    <td valign='top' style='font-size:12px;'><?php echo e(\Carbon\Carbon::parse($row["date_cloture"])->format('d/m/Y H:i')); ?></td>
                                    <td valign='top' style='font-size:12px;'><?php echo e($row->exams->first() ? \Carbon\Carbon::parse($row->exams->first()->date_exam)->format('d/m/Y H:i') : '-'); ?></td>
                                </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <table width="100%" cellspacing="0" cellpadding="2" border="0">
                                    <tbody>
                                        <tr>
                                            <td align="right" style="font-size:12px;"><b>Total </b><?php echo e($dossier_total); ?></td>
...
</script><?php /**PATH D:\laravel\volt-laravel-dashboard\resources\views/livewire/invoice.blade.php ENDPATH**/ ?>