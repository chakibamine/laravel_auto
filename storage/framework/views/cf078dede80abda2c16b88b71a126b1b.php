                ...
                <td valign="top">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td valign="top" width="30%" style="font-size:15px;">
                                    <strong>Date de Fiche:</strong> <?php echo e(now()->format('d/m/y')); ?><br><br>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $dossiers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dossier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($dossier->category === 'B' && $dossier->student->gender === 'masculin'): ?>
                                    <tr>
                                        <td class="header-cell"><?php echo e($i++); ?></td>
                                        ...
                                        <td><?php echo e($dossier->courses->where('type_cours', 'Pratique')->count()); ?></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="2" border="1" style="margin-top: 20px;">
                        ...
                        <tbody>
                            <?php $i = 1; ?>
                            <?php $__currentLoopData = $dossiers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dossier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($dossier->category === 'B' && $dossier->student->gender === 'feminin'): ?>
                                    <tr>
                                        <td class="header-cell"><?php echo e($i++); ?></td>
                                        <td><?php echo e($dossier->student->cin); ?></td>
                                        <td><?php echo e($dossier->student->lastname); ?> <?php echo e($dossier->student->firstname); ?></td>
