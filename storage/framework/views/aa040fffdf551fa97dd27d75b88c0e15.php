                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <?php if(!$student->dossiers()->where('status', 1)->exists()): ?>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e($editMode ? 'Modifier l\'Étudiant' : 'Ajouter un Nouvel Étudiant'); ?></h5>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="modal-footer">
                    ...
                    <button wire:click="save" type="button" class="btn btn-primary"><?php echo e($editMode ? 'Mettre à jour' : 'Insérer'); ?></button>
                </div>
            </div>
        </div>
    </div>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="alert alert-success alert-dismissible fade show position-fixed bottom-0 end-0 mb-4 me-4" role="alert">
        <?php echo e($editMode ? 'Étudiant mis à jour avec succès !' : 'Étudiant créé avec succès !'); ?>
    ...
    <?php endif; ?>
</div> <?php /**PATH D:\laravel\volt-laravel-dashboard\resources\views/livewire/student.blade.php ENDPATH**/ ?>