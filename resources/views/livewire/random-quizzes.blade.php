<div>
    ...
    <div id="quiz-container" class="d-flex flex-column align-items-center">
        @foreach($quizzes as $index => $quiz)
            <div class="quiz-item mb-4" id="quiz-{{ $index }}" style="display: none;">
                <img src="{{ Storage::url($quiz->image_url) }}" class="img-fluid mb-2" alt="Quiz Image" style="max-width: 300px;">
                <audio id="audio-{{ $index }}" controls class="mb-2">
