                    ...
                    <table width="100%" cellspacing="0" cellpadding="0">
                        <tbody>
                            ...
                            <div align="right" style="font-size: 14px;">
                                ...
                                <p>والسيد (ة) : {{ $dossier->student->lastname }} {{ $dossier->student->firstname }}</p>
                                <div style="display: flex; flex-direction:row; justify-content: flex-end;">
                                    ...
                                    <p style="margin-right: 50px;">المزداد(ة) ب : {{ $dossier->student->place_birth }}</p>
                                    <p>{{ $dossier->student->cin }} : رقم ب.و.ت.إ</p>
                                </div>
                                <p>القاطن (ة) ب : {{ $dossier->student->address }}</p>
