    ...
    <div class="receipt">
        ...
        <div style="display: flex; justify-content: space-between; margin-bottom: 20px;">
            <div>
                @if($dossier->student->image_url)
                    <img class="logo-img" src='{{ asset("storage/" . $dossier->student->image_url) }}' alt="Photo"><br>
                @endif
                <strong>Candidat : </strong>{{ $dossier->student->lastname }} {{ $dossier->student->firstname }}<br>
                <strong>Permis :</strong> {{ $dossier->category }}
            </div>
        ...
        <table width="100%" cellspacing="0" cellpadding="2" border="1" style="border-collapse: collapse; margin-bottom: 20px;">
            ...
            <tr>
                ...
                <td style="padding: 8px;">{{ now()->format('d/m/y') }}</td>
                <td style="padding: 8px;">{{ $dossier->student->lastname }} {{ $dossier->student->firstname }}</td>
